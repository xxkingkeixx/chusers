					...
					<div class="content">
						<div class="container">
							<div class="row">
								...
								<div class="4u$ 12u$(medium)">
									<p>
										All accounts are secured as chats to make transactions smooth and create an easy transition of ownership. Due to the high volume of requests for usernames, you should expect a wait time of 30 minutes to an hour at the latest. Our timezone is Eastern Standard Time (EST); if you are not located in the same time zone, be sure to notify a developer that you made a purchase.
										<br><br>
				...
				<section id="two" class="spotlight style2 right">
					...
					<div class="content">
						...
						<p>
							...
							<br><br>
							If you have any questions or concerns you can message the developer, or the helper bot (coming soon).
						</p>
					</div>
