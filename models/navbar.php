				...
				<header id="header">
					...
					<nav id="nav" style="margin-right:40px;">
						<ul>
							...
							<li id="list"> <input id="search" type="text" style ="border-radius:33px;height:25px;" method="post" name="user_name" maxlength="50" action="search_results.php" class="form-control" placeholder="Search for Usernames" /></li>
						<!-- Developers -->
							<li id="list">
								<a href="/">Developers</a>
							</li>
