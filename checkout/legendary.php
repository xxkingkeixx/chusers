...
<table>
<tr><td><input type="hidden" name="on0" value="Account Options">Account Options</td></tr><tr><td><select name="os0">
...
<td valign="top"><input  type="text" name="telephone" maxlength="30" size="30"></td></tr>
<tr>
